...
const HeroSection = () => {
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
        ...
        {/*The bigger text in hero section standing out  */}
        ...
        {/*The paragraph section inside the hero section   */}
        <p className="mt-10 text-lg text-center text-neutral-500 max-w-4xl">
            Empower your creativity and bring your VR app ideas to life with our intuitive
            development tools.Get started today and turn your 
            imagination into immersive reality! 
        </p>
          
          {/* Button using anchors */}
        <div className="flex justify-center my-10">
          <a href="#" className=" rounded bg-gradient-to-r from-orange-500 to-red-900 px-4 mx-3 py-3">
             Start for free
           </a>
